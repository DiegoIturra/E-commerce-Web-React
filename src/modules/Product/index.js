    ...
    <section className="text-gray-600 body-font overflow-hidden bg-gray-900">
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <img
            alt={product?.title}
            className="lg:w-1/2 w-full lg:h-auto max-h-[600px] h-64 object-contain object-center rounded border-2 border-gray-800"
            src={product?.image}
          />
            ...
            <div className="flex justify-between items-center">
              ...
              <button className="rounded-full w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center text-gray-500 ml-4">
                <svg
                  ...
                  viewBox="0 0 24 24"
                >
                  <path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78L5.67 12l-1.06 1.06a5.5 5.5 0 007.78 7.78L12 20.33l1.06 1.06a5.5 5.5 0 007.78-7.78L20.33 12l1.06-1.06a5.5 5.5 0 000-7.78z"></path>
                </svg>
              </button>
            </div>
          </div>
