...
<footer className="text-gray-600 body-font border-t-2 bg-gray-900">
  <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
    <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
      ...
      <p className="mt-2 text-sm text-gray-400">Expertos en tecnologia</p>
    </div>
  ...
  <div className="bg-gray-800">
    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
      <p className="text-gray-500 text-sm text-center sm:text-left">© Prototech — 2023
        <a href="https://www.youtube.com/watch?v=MKaeF-bYOLk&ab_channel=WarnerMusicSpain" rel="noopener noreferrer" className="text-gray-400 ml-1" target="_blank">@nohaytwitter</a>
      </p>
